...
row = table(string(combinationId), numel(strainNames), string(strjoin(strainNames, ';')), ...
    ...
    fluxes.dinitrogen.secretion, fluxes.carbon_dioxide.secretion, fluxes.ammonium.uptake, fluxes.ammonium.secretion, ...
    safeDivide(fluxes.nitrate.uptake, totalBiomass), ...
    ...
    'n2_secretion','co2_production','nh4_uptake','nh4_secretion', ...
    'nitrate_uptake_per_biomass','n2o_uptake_per_biomass','n2_production_per_biomass', ...
